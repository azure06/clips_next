      ...
      <ElevationScroll {...props}>
        ...
        >
          <Toolbar>
            ...
            <React.Fragment>
              <Button
                color={router.pathname === '/jp/features' ? 'primary' : 'inherit'}
                disableElevation
                className={classes.toolbarBtn}
                onClick={e =>
                  router.push({
                    pathname: '/jp/features',
                  })
                }
              >
                機能
              ...
              <Button
                color={router.pathname === '/jp/premium' ? 'primary' : 'inherit'}
                disableElevation
                className={classes.toolbarBtn}
                onClick={e =>
                  router.push({
              ...
              <Button
                color={router.pathname === '/jp/blog' ? 'primary' : 'inherit'}
                disableElevation
              ...
              <Button
                color={router.pathname === '/jp/about' ? 'primary' : 'inherit'}
                disableElevation
                className={clsx(classes.toolbarBtn, 'hideXS')}
                onClick={e =>
                  router.push({
