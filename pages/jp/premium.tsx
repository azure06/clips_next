...
export default function Home(): JSX.Element {
  ...
  const free = [
    { value: '検索', divider: false },
    { value: '', divider: true },
    { value: 'ラベル', divider: true },
    { value: 'Google ドライブバックアップ', divider: false },
  ];
  const premium = [
    { value: '検索', divider: false },
    { value: '曖昧検索', divider: true },
    { value: 'ラベル', divider: true },
    { value: 'Google ドライブバックアップ', divider: true },
    { value: 'RTF、HTML テキストの保存', divider: false },
    { value: 'Google ドライブと自動同期', divider: false },
    { value: '自動で履歴を削除', divider: false },
  ];
